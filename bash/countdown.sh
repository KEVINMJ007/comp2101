...
function exitnow {
  echo " ! you found a way to quit the loop"
  exit
}
...
function error-message {
  # it will print out the programname with first command line argument and moose printing statment
  # >&2 will send the output of echo to standard error instead of standard output.D
